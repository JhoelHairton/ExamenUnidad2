...
public class ModeloJuego {
    ...
    public void marcarCasilla(int i, int j, JLabel[][] casillas, MainJuego view) {
    ...
    private void terminarJuego(MainJuego view) {
        if (draw) {
            ResultadoTO to = view.uTO;
            ...
            if (turno.equals("X")) {
                ...
                rDao.update(to);
                view.ListarResultado();
                JOptionPane.showMessageDialog(null, "Triunfo de " + to.getNombreJugador1());
            } else {
                victoriasJ2++;
                ...
                rDao.update(to);
                view.ListarResultado();
                JOptionPane.showMessageDialog(null, "Triunfo de " + to.getNombreJugador2());
            }
        }
    }
    ...
    void AnularGame(JLabel[][] casillas,MainJuego view) {
        turno = "X";
        end = false;
        draw = false;
        cantMovidas = 0;
